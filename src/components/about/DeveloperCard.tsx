        ...
        <div>
            ...
            {developer.website && (
                <a href={developer.website} target="_blank" rel="noopener noreferrer">
                    <Image src="/assets/icons/website-icon.png" alt={`${developer.name} Website`} width={20} height={20} className="inline-block" /> 
                </a>
            )}
            {developer.linkedin && (
                <a href={developer.linkedin} target="_blank" rel="noopener noreferrer">
                    <Image src="/assets/icons/linkedin-icon.png" alt={`${developer.name} LinkedIn`} width={28} height={28} className="inline-block" /> 
                </a>
            )}
            {developer.github && (
                <a href={developer.github} target="_blank" rel="noopener noreferrer">
                    <Image src="/assets/icons/github-icon.png" alt={`${developer.name} Website`} width={20} height={20} className="inline-block" /> 
                </a>
            )}
        </div>
    );
