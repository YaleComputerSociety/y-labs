import { ListingBackup } from "@/lib/models";
import { NotFoundError, ObjectIdError } from "@/lib/utils/errors";
...
export const createListingBackup = async (data: any) => {
    try {
        ...
        throw new Error('Unknown error occurred while creating listing backup');
    }
};
...
export const readAllListingBackups = async () => {
    try {
        ...
        throw new Error('Unknown error occurred while reading listing backup');
    }
};
